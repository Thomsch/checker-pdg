...
public class PdgExtractor {
    ...
    public void run(String file, String sourcePath, String classPath, String path_out) {
        ...
        for (final MethodTree methodTree : processor.getMethods()) {
            // Build graph nodes
            PdgMethod pdgMethod = buildPdgGraph(processor, methodTree);
    ...
    public PdgMethod buildPdgGraph(final FileProcessor processor, final MethodTree methodTree) {
     ...
     */
    private String printDot(Set<PdgMethod> graphs) {
...
/**
     ...
     */
    private String printGraph(PdgMethod graph, int cluster) {
    ...
    private String printSubgraphLabel(final PdgMethod graph) {
